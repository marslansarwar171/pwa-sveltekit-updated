...
<SectionWrapper id="hero">
  ...
  >
    ...
    >
      <span class="text-indigo-400">Web</span> Dev
    ...
    >
      Less thinking & more doing. We're the instructors teaching students about
      modern
      <span class="italic"
        >web development, devops, cyber security, data science</span
      >
      and much much more.
    </p>
  </div>
